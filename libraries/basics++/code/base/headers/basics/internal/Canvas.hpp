...
#define BASICS_CANVAS_HEADER
    ...
    namespace basics
    {
        ...
        public:
            ...
            virtual void set_viewport    (const Point2u & bottom_left, const Size2u & size) { }
        ...
        public:
            ...
            virtual void fill_rectangle  (const Point2f & where, const Size2f & size, const Texture_2D * texture, int anchor = CENTER) { }
