...
#include <basics/macros>
    ...
    namespace
    {
        ...
        {
            /*REMOVE*/log.i ("ON INPUT QUEUE CREATED");
        ...
        {
            /*REMOVE*/log.i ("ON INPUT QUEUE DESTROYED");
