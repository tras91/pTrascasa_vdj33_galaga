...
#define SPRITE_HEADER
    ...
    namespace example
    {
        ...
        public:
            ...
            bool getInnerOrientation(){
                return innerOrientation;
            }
        ...
        public:
            ...
            void setInnerOrientation(const bool b){
                innerOrientation = b ;
            }
        ...
        public:
             ...
             */
            bool intersects (const Sprite & other, float scale);
        ...
        public:
            ...
            bool contains(const Point2f &point, float scale);
        };
