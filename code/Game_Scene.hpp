...
#define GAME_SCENE_HEADER
    ...
    namespace example
    {
        ...
        private:
            ...
            static constexpr float player_speed = 420.f;        ///< Velocidad a la que se mueven ambos jugadores (en unideades virtuales por segundo).
            static constexpr float enemy_speed = 270.f;        ///< Velocidad a la que se mueven ambos jugadores (en unideades virtuales por segundo).
        ...
        private:
            ...
            Sprite       * buttonPause;
            Sprite       * final;                        // Puntero que representa la meta.
            Sprite       * instructions;                 // Puntero que representa las instrucciones
        ...
        private:
            ...
            float GetInitialOrFinalScaledHeights(const Sprite & sprite , const bool initialFinal, float scale)const;
            bool ResetTrunksCarsSpeed();
            void fillCustomList(const float & initialPositionY, const float & thisObjectHeight, std::vector<Sprite *> & list,
            ...
            void resetObstaclePosition(Sprite * sprite);
        };
